...
ax.plot(df_pro['Date'], df_pro['(375-400)']*100, label='50bp 인하(3.75-4.00%)', ls='--', lw=1, color='green')
ax.plot(df_pro['Date'], df_pro['(400-425)']*100, label='25bp 인하(4.00-4.25%)', lw=2, color='red')
ax.plot(df_pro['Date'], df_pro['(425-450)']*100, label='동결(4.25-4.5%)', lw=1, color='blue')
