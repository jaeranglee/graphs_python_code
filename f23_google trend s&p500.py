...
ax_right.plot(df_sp_filtered['observation_date'], df_sp_filtered['SP500'], label='S&P500(우측)', color='red', lw=1.5)

ax.grid(True, linestyle='--', linewidth=0.7, alpha=0.7)

ax_right.text(1, 1.00, '(S&P 500 지수)', ha='right', va='bottom', color='red',
         fontsize=12, rotation=0, transform=ax.transAxes)
