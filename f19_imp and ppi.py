...
ax[0].plot(df['observation_date'], df['YoY_PPI'], lw=2, color='r')
...
ax[0].scatter(highlight_point_ppi_yoy['observation_date'], highlight_point_ppi_yoy['YoY_PPI'],
           color='r', marker='x', s=100, linewidth=2, label="2024년 8월 생산자물가")
...
ax[1].plot(df['observation_date'], df['MoM_PPI'], lw=2, color='r')
