...
ax.plot(merged["Record Date"], merged["Total Debt"], label="총부채", linewidth=2)
ax.plot(merged["Record Date"], merged["Closing Balance Today"], label="법정 부채한도",linestyle='--', linewidth=2, color='red')
