...
# 왼쪽: 국채금리
ax[0].plot(tb1['observation_date'], tb1['DGS10'], label='10년물', lw=2, color='red')
ax[0].plot(tb1['observation_date'], tb1['DGS2'], label='2년물', lw=2, color='blue')
...
ax[1].plot(df2['observation_date'], df2['WSHOTSL']/1e6, label='국채', lw=2, color='red')
