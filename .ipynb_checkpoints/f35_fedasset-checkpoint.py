...
df_all.plot.area(ax=ax, stacked=True, alpha=0.6, color=colors[:df_all.shape[1]])

ax.plot(df_filtered.index, df_filtered['RESPPANWW'], label='총자산', lw=2, color='black')
