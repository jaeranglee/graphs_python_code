...
ax.plot(bills.index, bills["Value (millions)"], label="Bills", color="black", lw=2)
ax.plot(notes.index, notes["Value (millions)"], label="Notes", color="gray", lw=2, ls='-')

# Bond position 데이터
ax.plot(bonds.index, bonds["Value (millions)"], label="Bonds", color="black", lw=1, ls='-')
ax.plot(notes10.index, notes10["Value (millions)"], label=None, color="black", lw=1)
