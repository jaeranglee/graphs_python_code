...
for i in [1,2]:
    ...
    if i == 1:
        ...
        ax.plot(sofr_vol['observation_date'], sofr_vol['Volume'], label='SOFR', lw=2, color='green')
        ax.plot(tgcr_vol['observation_date'], tgcr_vol['Volume'], label='TGCR', lw=2, color='blue')
        ax.plot(effr_vol['observation_date'], effr_vol['Volume'], label='EFFR', lw=2, color='orange')
    ...
    # 시각화:
        ...
        ax.plot(effr['observation_date'], effr['Rate'], label='EFFR', lw=2, color='orange')
