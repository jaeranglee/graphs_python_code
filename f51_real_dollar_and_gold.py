...
ax[0].plot(dbxy_df['observation_date'], dbxy_df['DTWEXBGS'], label='명목 달러인덱스', lw=1, color='orange')
...
ax_left.plot(dfs['Gold']['Date'], dfs['Gold']['Value'], label='금', lw=2, color='red', alpha=1.0)
ax_right.plot(df2['observation_date'], df2['RBXMBIS'], label='실질실효 유로인덱스', lw=2, color='orange')
