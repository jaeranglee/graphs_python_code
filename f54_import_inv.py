...
ax[0].plot(imp0004['observation_date'], imp0004['YoY'], label='통관기준 수입', lw=2, color='red')
...
ax[1].plot(invq1['observation_date'], invq1['A014RY2Q224SBEA'], label='GDP기준 재고투자', lw=2, color='red')
